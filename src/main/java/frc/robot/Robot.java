...
*/
  ...
  public void teleopPeriodic() {
    ...
    if(speedClutch){
      ...
      DriveTrain.differentialDrive.arcadeDrive((forward * Constant.speedMultiplier), (turn * Constant.speedMultiplier));
    }else{
      ...
      DriveTrain.differentialDrive.arcadeDrive(forward, turn);
    }
